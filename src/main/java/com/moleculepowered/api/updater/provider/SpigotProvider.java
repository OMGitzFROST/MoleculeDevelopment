...
public class SpigotProvider extends AbstractProvider
{
    ...
    public SpigotProvider(int resourceID) {
        super("https://api.spigotmc.org/legacy/update.php?resource={0}", String.valueOf(resourceID));
        this.providerVersion = "1.0";
        this.providerAuthor = "MoleculePowered";
        this.downloadLink = Util.format("https://www.spigotmc.org/resources/{0}/", String.valueOf(resourceID));
     ...
     */
    @Override
    public @NotNull String getProviderName() { return "Spigot"; }
