...
public class SpigetProvider extends AbstractProvider
{
    ...
    public SpigetProvider(int resourceID) {
        super("https://api.spiget.org/v2/resources/{0}/versions/latest", String.valueOf(resourceID));
        this.providerVersion = "1.0";
        this.providerAuthor = "MoleculePowered";
        this.downloadLink = Util.format("https://api.spiget.org/v2/resources/{0}/versions/latest/download", String.valueOf(resourceID));
    }
    ...
    public boolean initialize() throws IOException{
        ...
        remoteVersion = resource.get("name").getAsString();
        return true;
    }
     ...
     */
    @Override
    public @NotNull String getProviderName() { return "Spiget"; }
